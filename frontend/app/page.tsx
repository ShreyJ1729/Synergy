...
export default function Home() {
  ...
  return (
    <>
      <Navbar />
      <main className="flex h-screen flex-col items-center py-24 px-0 md:p-24">
        ...
        <div className="relative flex place-items-center">
          <h1 className="text-center text-white text-6xl font-semibold leading-snug">
            The{" "}
        ...
        <div className="text-gray-300 text-center my-4 text-lg">
          An AI-powered sounding board for all your thoughts.
        </div>
        <Link
          className="bg-yellow-300 text-black font-semibold rounded-full py-3 px-6 my-8"
          href="/try"
        >
          Try It Now
        </Link>
